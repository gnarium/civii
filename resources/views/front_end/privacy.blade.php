            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-12 col-md-7">
                        <h1 class="m-b20 m-t0">Welcome to Engineering's Destination Privacy Policy </h1>
                        <div class="dez-separator bg-primary"></div>
                        <!-- <ul class="list-check-circle primary">
                            <li>THE CORE PURPOSE OF THE CHANNEL IS TO GIVE AUTHENTIC JOB UPDARTES And IMPORTANT NOTIFICATIONS. HOWEVER, WE DOES NOT GUARENTEE EMPLOYMENT.</li>
                            <li>WE DO NOT CHARGE ANY FEES, MONEY OR DONATION FROM ANY CANDIDATE FOR ANY EMPLOYMENT .</li>
                            <li>WE DO NOT PROVIDE ANY REFERENCE FOR ANY JOBS OR EMPLOYMENT. </li>
                        ...
                        <!-- <p>WELCOME TO ENGINEERING DESTINATION THESE TERMS AND CONDITIONS OUTLINE THE RULES AND REGULATIONS FOR THE USE OF ENGINEERING DESTINATION</p> -->
                        <!-- <ul class="list-check-circle primary">
                            <li>BY ACCESSING THIS WEBSITE WE ASSUME YOU ACCEPT THESE TERMS AND CONDITIONS. DO NOT CONTINUE TO USE WEBSITE NAME IF YOU DO NOT AGREE TO TAKE ALL OF THE TERMS AND CONDITIONS STATED ON THIS PAGE.</li>
                            <li>WE DO NOT OFFER EMPLOYMENT.</li>
                            <li>WE DO NOT HAVE ANY COLLABARATION FROM ANY ORGANIZATION OR CONSULTANCY. </li>
                            <li>ENGINEERING DESTINATION DO NOT TAKE ANY MONEY FROM ANY INDIVIDUAL OR ANY ORGANIZATION.</li>
                            <li>WE DO NOT TAKE RESPONSIBITY FOR ANY MONEY ASKED FROM ANY THIRD PARTY.</li>
