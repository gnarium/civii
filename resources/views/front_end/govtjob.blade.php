							...
							<div class="col-md-6 col-lg-4 col-sm-6 m-b30 product-item card-container">
								<div class="dez-box "style="background-color:#FDC716">
									<div class="dez-info p-a20">
                                        ...
                                        <h6 class="m-b0" style="text-align:justify;">Company Name:</h6><span><p>{{$todo1->companyname}}</p></span>
                                        <h6 class="m-b0" style="text-align:justify;">Designation:</h6><span><p>{{$todo1->jobname}}</p></span>
                                        <h6 class="m-b0" style="text-align:justify;">Branch:</h6><span><p>{{$todo1->branch}}</p></span>
                                        <h6 class="m-b0" style="text-align:justify;">Eligibility:</h6><span><p>{{$todo1->eligibility}}</p></span>
                                        <h6 class="m-b0" style="text-align:justify;">Last Date:</h6><span><p>{{$todo1->lastdate}}</p></span>
										<div class="m-t10">
