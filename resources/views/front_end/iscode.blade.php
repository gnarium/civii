        ...
        @foreach($todoArr as $todo)
            <tbody>
                <tr>
                    ...
                    <td><a href="{{$todo->url}}"><script async src="https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js?client=ca-pub-3775391448345901"
