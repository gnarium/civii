        ...
        @foreach($todoArr as $todo)
            <tbody>
                <tr>
                    ...
                    <td><script async src="https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js?client=ca-pub-3775391448345901"
...
</script><a href="{{$todo->url}}">{{$todo->iscode}}</a></td>
