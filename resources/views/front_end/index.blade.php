				...
				<div class="row">
					<div class="col-lg-12 col-md-7 col-sm-12">
						...
						<div class="row" id="masonry" >
							...
							<div class="col-md-6 col-lg-3 col-sm-6 m-b30 product-item card-container" >
									<div class="dez-thum-bx  dez-img-effect "> <a href="{{ asset('user/front_end/images/Hnet.com-image (2).webp')}}" target="_blank"><img src="{{ asset('user/front_end/images/Hnet.com-image (2).webp')}}" style="height:250px;border-raduis:25%;" alt=""></a>
									</div>
							</div>
							<div class="col-md-6 col-lg-3 col-sm-6 m-b30 product-item card-container">
									<div class="dez-thum-bx  dez-img-effect "><a href="{{ asset('user/front_end/images/Hnet.com-image (3).webp')}}" target="_blank"> <img src="{{ asset('user/front_end/images/Hnet.com-image (3).webp')}}"  style="height:250px;border-raduis:25%;" alt=""></a>
									</div>
							</div>
							<div class="col-md-6 col-lg-3 col-sm-6 m-b30 product-item card-container">
									<div class="dez-thum-bx  dez-img-effect "><a href="{{ asset('user/front_end/images/Hnet.com-image.webp')}}" target="_blank"> <img src="{{ asset('user/front_end/images/Hnet.com-image.webp')}}"style="height:250px;border-raduis:25%;" alt=""></a>
									</div>
							</div>
                 		</div>
