        ...
        @include('front_end.flash')
                <div class="col-lg-12">
                    ...
                    <div class="panel-body">
                        <div class=" form">
                            <form class="cmxform form-horizontal" method="post" action="/admin/adminpages/iscode" novalidate="novalidate"  enctype="multipart/form-data">
                                {{ csrf_field()}}
                                <div class="form-group ">
                                    <label for="cname" class="control-label col-lg-3">Code ID (required)</label>
                                        <div class="col-lg-6">
                                            <input class=" form-control" id="cname" name="CodeId" type="text" required="">
                                        </div>
                                    </div>
                                    <div class="form-group ">
                                        <label for="cemail" class="control-label col-lg-3">Code Describtion(required)</label>
                                        <div class="col-lg-6">
                                            <input class="form-control " id="cemail" type="text" name="CodeDescribtion" required="">
                                        </div>
                                    </div>
                                    <div class="form-group ">
                                        <label for="curl" class="control-label col-lg-3">URL</label>
                                        <div class="col-lg-6">
                                            <input class="form-control " id="curl" type="url" name="ISCODEUrl">
                                        </div>
                                    </div>
                                    <div class="form-group">
