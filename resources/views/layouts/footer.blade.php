					...
					<div class="col-lg-3 col-md-6 col-sm-6 footer-col-4">
						<div class="widget widget_getintuch" style="margin-left:-5px">
							...
							<ul>
								...
								<li><i class="fa fa-envelope"></i><strong>Email</strong>engineeringdestination140@gmail.com<b style="text-align:left;"><br/><br/>Note</b> : We do not provide job , please do not send your cv or any other document on this email.This is for informative purpose only.</li>
							</ul>
						</div>
					</div>
					<div class="col-lg-3 col-md-6 col-sm-6 footer-col-4">
