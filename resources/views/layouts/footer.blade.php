<footer class="site-footer">
					...
					<div class="col-lg-3 col-md-6 col-sm-6 footer-col-4">
						<div class="widget widget_getintuch" style="margin-left:-8px">
							...
							<ul>
								...
								<li><i class="fa fa-envelope"></i><strong>E-mail</strong>engineeringdestination140@gmail.com<b style="text-align:left;"><br/>Note:</b>  We do not provide jobs , Kindly do not email your cv or any other documents on this email.The website is for information purpose only.</li>
							</ul>
						</div>
					</div>
					<div class="col-lg-3 col-md-6 col-sm-6 footer-col-4">
		...
		<div class="footer-bottom">
			<div class="container">
				<div class="row">
					<div class="col-lg-4 text-left" ><span style="font-size:14px;">Design & Develop By<a href="https://www.gnariumiqnovative.com" target="_blank">Gnarium Iqnovative Pvt. Ltd.</a></span></div>
